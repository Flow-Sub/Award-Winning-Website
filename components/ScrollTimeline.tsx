...
export const ScrollTimeline = ({
    ...
    return {
      ...
      whileInView: {
        ...
        transition: {
          duration: 0.7,
          delay: baseDelay,
          ease: [0.25, 0.46, 0.45, 0.94], // Match project's easing
        },
      },
  ...
  const getCardClasses = (index: number) => {
    const baseClasses = "relative z-30 rounded-lg transition-all duration-300 glass-effect magnetic-hover";
  ...
  return (
    ...
    >
      <div className="text-center py-16 px-4">
        <h2 className="text-3xl md:text-5xl font-serif font-light mb-4 gradient-text">{title}</h2>
        <p className="text-lg font-mono text-muted-foreground max-w-2xl mx-auto tracking-wide">
          {subtitle}
        </p>
      </div>
            ...
            <>
              <motion.div
                ...
                style={{
                  ...
                  background: `linear-gradient(to bottom, oklch(0.646 0.222 41.116), oklch(0.6 0.118 184.704), oklch(0.769 0.188 70.08))`, // Use OKLCH colors
                  boxShadow: `
              ...
              >
                <motion.div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, oklch(0.488 0.243 264.376) 0%, oklch(0.696 0.17 162.48) 40%, transparent 70%)",
                    boxShadow: `
            ...
            {events.map((event, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Card className="bg-background/90 border-primary/30 hover:shadow-md border">
                      <CardContent className="p-6">
                        {dateFormat === "badge" ? (
                          ...
                          <p className="text-lg font-mono font-bold text-primary mb-2 tracking-wide">
                            {event.year}
                          </p>
                        )}
                        ...
                        {event.subtitle && (
                          <p className="text-muted-foreground font-mono text-sm mb-2 tracking-wide">
                            {event.subtitle}
                          </p>
                        )}
