...
const projects: Project[] = [
  {
    id: '1',
    title: 'NodeFlow: AI-Powered Automation Builder',
    category: 'AI + Web App',
    description: 'A drag-and-drop automation platform with custom nodes for workflows, chat broadcasts, and email marketing—reducing campaign setup time by 60% for businesses.',
  ...
  {
    id: '2',
    title: 'VoiceSync: AI Agent for Real-Time Support',
    category: 'AI + Voice Tech',
    description: 'An AI voice agent that handles customer queries, schedules appointments, and integrates with CRM systems—cutting response times by 75% for service teams.',
  ...
  {
    id: '3',
    title: 'SkyTrack: AI-Powered Flight Management',
    category: 'AI + Web/App',
    description: 'A real-time flight tracking system with automated alerts, dynamic pricing analysis, and passenger communication—boosting operational efficiency for airlines by 40%.',
    image: 'https://t4.ftcdn.net/jpg/10/94/50/25/360_F_1094502569_2tYv99UI5N9C1DqN2RpU3I7WoyNyp42n.jpg',
    tags: ['Automation', 'Travel Tech', 'AI'],
    gradient: 'from-green-900/30 to-black',
    glow: '[0_0_20px_rgba(16,185,129,0.3)]',
  },
  {
    id: '4',
    title: 'AppFusion: AI-Driven Cross-Platform Builder',
    category: 'AI + App/Web Dev',
    description: 'A unified platform to design, deploy, and scale AI-enhanced mobile/web apps with pre-built templates—accelerating development cycles by 50% for startups.',
    ...
    tags: ['AI Integration', 'Low-Code', 'Scalability'],
